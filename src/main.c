...
int main() {
  ...
  printf("Size: %ld\nCap: %ld\n", int_vector_get_size(new_new),
         int_vector_get_capacity(new_new));
  ...
  printf("Size: %ld\n Cap: %ld\n", int_vector_get_size(new_1),
         int_vector_get_capacity(new_1));
  NEWLINE;
